...
if(isset($_POST["Modifier"]))
{
	...
	//Requête
$requete = $connexion->query("UPDATE utilisateurs SET activite='$activite', nombre='$nombre', email='$email' WHERE id='$id'");

	//Renvoi à la page des réservations
...
if(isset($_GET['modification']))
{
    ...
    $id = htmlspecialchars($_GET['modification']);

    // On prépare la requête
    $requete = $connexion->query("SELECT * FROM utilisateurs WHERE id = '$id'");


    if(!empty($requete))
    {
        while($modif = $requete->fetch(PDO::FETCH_ASSOC)){
									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											...
											<form action="modification.php" method="post">
												<div class="row form-group">
													<div class="col-md-12">
														...
														<select name="activite" id="activities" class="form-control">
															<option value="">Votre ancienne réservations: <?=$activite?></option>
												...
												<div class="row form-group">
													<div class="col-md-12">
														<input type="number" name="nombre" id="nombre" class="form-control" value="<?=$nombre?>" placeholder="Nombre de personne" require="required" autocomplete="off">
														
													</div>
												</div>		
                                                <div class="row form-group">
													<div class="col-md-12">
														<input type="email" name="email" id="email" class="form-control" value="<?=$email?>" placeholder="Votre Email" require="required" autocomplete="off">
													</div>
												</div>                                              
												<div class="row form-group">
													<div class="col-md-12">
